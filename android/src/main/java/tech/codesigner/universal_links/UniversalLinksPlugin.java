package tech.codesigner.universal_links;
...
/** UniversalLinksPlugin */
public class UniversalLinksPlugin extends BroadcastReceiver
        implements FlutterPlugin, MethodCallHandler, ActivityAware, NewIntentListener {

  private static final String MESSAGES_CHANNEL = "tech.codesigner.universal_links/messages";
  private static final String TAG = "tech.codesigner.universal_links";
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    } else if (call.method.equals("setUrlPatten")) {
      urlPatten = call.argument("urlPatten");
    } else {
